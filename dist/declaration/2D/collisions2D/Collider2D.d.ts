...
export declare abstract class Collider2D {
    abstract testCollision(transform: Transform2D, collider: Collider2D, colliderTransform: Transform2D): CollisionPoints;
